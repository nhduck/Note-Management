...
const LoginPage = () => {
  ...
  // Handle network authentication lifecycle using jQuery AJAX
  const handleSubmit = (e) => {
    ...
    $.ajax({
      ...
      success: (res) => {
        // Persist verification tokens and identity credentials into local web storage
  ...
  return (
    <div className="form-side">
      <main className="login-card">
        ...
        <p className="card-subtitle mb-4 text-muted">Please enter your details to log in.</p>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <button type="submit" className="btn-submit">
            Log In <i className="bi bi-arrow-right-short"></i>
          </button>
        </form>
